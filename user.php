...
<a href="exit.php"><p class="nick"><?php echo $_SESSION['user']->name ?></p></a>

		<a class="kvadrat"><img class="content_user" src="user2.png"></a>
				<img class="orange" src="orange.png">
			<p class="reg">На сайте с:</p>
				<p class="reg_data">14.03.2022</p>
